...
![Tests](https://img.shields.io/badge/regression%20tests-103%20passing-3FB950)
...
`validate-pipeline.py` is the enforcement layer — ~40 checks across six phase gates, backed by **103 regression tests** that encode real failures found in live runs. It rejects, among many others:
...
python3 agents/astro-static/scripts/test_regressions.py        # 103 tests
